...
export async function registerUser(fullname, email, password, password2) {
    ...
    //     method: 'POST',
    //     body: JSON.stringify({"fullname":fullname, "email":email, "password":password, "password2":password2}),
    //     headers: {
    //         'content-type': 'application/json',
    //     },
    // });
