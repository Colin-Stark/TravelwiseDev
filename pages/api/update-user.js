// filepath: c:\Users\cynth\Computer Programming and Analysis\Sem 6\TravelwiseDev\pages\api\update-user.js
export default async function handler(req, res) {
    ...
    try {
        ...
        const externalResponse = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/userManagement/update-user`, {
            method: 'POST',
            headers: {
